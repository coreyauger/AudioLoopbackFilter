//------------------------------------------------------------------------------
// File: AudioLoopbackFilter.cpp
//
// Desc: (CA) Mode from DirectShow sample code 
//		- implements CDynamicSource, which is a
...
STDMETHODIMP CDynamicSource::SetSyncSource(IReferenceClock *pClock)
{
	((CDynamicSourceStream*) GetPin(0))->SetSyncSource(pClock);
